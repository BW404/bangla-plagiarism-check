...
# st.markdown("Compare two Bangla texts and predict if the second one is plagiarized.")

# # Input fields
# original_text = st.text_area("Original Text", height=150)
# plagiarized_text = st.text_area("Suspected Plagiarized Text", height=150)

# # Check button
# if st.button("🔍 Check Similarity & Predict"):
...
#         st.markdown(f"**Cosine Similarity:** `{cosine_sim:.4f}`")
#         if prediction == 1:
#             st.error("⚠️ Prediction: **Plagiarized**")
#         else:
#             st.info("✅ Prediction: **Original**")
...
#         <p>© 2025 Bangla Plagiarism Checker </p>
#         <p style='font-size: 12px;'>By Jalal Uddin Taj</p>
#     </div>
#     """,
